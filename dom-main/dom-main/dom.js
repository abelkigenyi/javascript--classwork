...
addButton.addEventListener("click"/*this represents the event javascript listens for*/,/*the second parameter must be a function*/ function () {
...
addBranch.addEventListener("click", function () {
    let newBranch = document.createElement("p"/*this represents that u a adding a paragraph*/);
    newBranch.textContent/*in this new paragraph u a creating, add this text wic is represented by textcontent*/ = "Matuga";
  
    container/*this is the div part with the container*/.appendChild(newBranch);
  });
